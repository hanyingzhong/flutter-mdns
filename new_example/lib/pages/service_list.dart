...
class ServiceList extends StatelessWidget {
  ...
  SnackBar snackBarWithText(String text) {
    return SnackBar(content: Text(text), duration: const Duration(seconds: 1));
  }
        ...
        return Card(
          ...
          ButtonTheme.bar(
            ...
            FlatButton(
                ...
                onPressed: () => appBloc
                    .add(AppEventDiscovery(AppEventDiscoveryState.Restart)))
          ]))
        ]));
      });
}
